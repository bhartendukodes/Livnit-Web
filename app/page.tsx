      ...
      <div className="min-h-screen flex flex-col bg-white">
        ...
        <nav className="shrink-0 flex items-center justify-between px-6 py-3 border-b border-gray-100 bg-gray-50/50">
          ...
          <button
            ...
            className="text-sm font-medium text-gray-600 hover:opacity-80"
    ...
    <div className="h-screen flex flex-col overflow-hidden bg-white">
      ...
      <nav className="shrink-0 flex items-center justify-between px-8 py-4 border-b border-gray-100 bg-gray-50/50">
        ...
        >
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 leading-tight transition-colors" style={{ color: 'rgb(var(--primary-500))' }}>Livinit</h1>
            <p className="text-sm font-medium leading-tight" style={{ color: 'rgb(var(--primary-500))' }}>AI Design Studio</p>
          </div>
        </a>
        <div className="flex items-center gap-6">
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="text-sm font-bold uppercase tracking-wide text-gray-500 transition-colors hover:opacity-80"
            style={{ color: 'rgb(var(--primary-500))' }}
          >
            Partner
          </a>
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="text-white px-5 py-2.5 rounded-full text-sm font-bold uppercase tracking-wide transition-colors hover:opacity-90"
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="space-y-8 animate-in fade-in duration-1000 max-h-full">
          ...
          <div className="text-center max-w-5xl mx-auto space-y-4 shrink-0">
            <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full text-xs font-bold uppercase tracking-[0.25em]" style={{ backgroundColor: 'rgba(var(--primary-500), 0.08)', border: '1px solid rgba(var(--primary-500), 0.2)', color: 'rgb(var(--primary-500))' }}>
              <IconSparkles />
            ...
            <h2 className="text-4xl md:text-6xl font-serif font-bold text-gray-900 tracking-tight leading-none whitespace-nowrap">
              Livinit <span className="italic font-light" style={{ color: 'rgb(var(--primary-500))' }}>Design Studio</span>
            </h2>
          ...
          <div className="max-w-5xl mx-auto bg-white rounded-[3rem] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.04)] border border-gray-100 overflow-hidden flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200 border-b border-gray-100 shrink-0">
              ...
              {/* 02. Dimensions */}
              <div className={`p-6 md:p-8 group cursor-pointer hover:bg-gray-50/50 transition-colors ${selectedDimensions !== 'Standard (150-300 sqft)' ? 'bg-[rgb(var(--primary-50))]/80' : ''}`}>
                <label className="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-3">
                  02. Dimensions
                </label>
                <div className="relative">
                  <select
                    ...
                    className={`w-full bg-transparent text-base md:text-lg font-bold outline-none appearance-none cursor-pointer transition-colors ${selectedDimensions !== 'Standard (150-300 sqft)' ? '' : 'text-gray-900'}`}
                    style={selectedDimensions !== 'Standard (150-300 sqft)' ? { color: 'rgb(var(--primary-600))' } : undefined}
                  >
              ...
              <div className={`p-6 md:p-8 group cursor-pointer hover:bg-gray-50/50 transition-colors ${selectedBudget !== 'Standard ($5k - $15k)' ? 'bg-[rgb(var(--primary-50))]/80' : ''}`}>
                <label className="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-3">
                ...
                <div className="relative">
                  <select
                    ...
                    className={`w-full bg-transparent text-base md:text-lg font-bold outline-none appearance-none cursor-pointer transition-colors ${selectedBudget !== 'Standard ($5k - $15k)' ? '' : 'text-gray-900'}`}
                    style={selectedBudget !== 'Standard ($5k - $15k)' ? { color: 'rgb(var(--primary-600))' } : undefined}
                  >
            ...
            <div className="px-8 py-4 shrink-0">
              <div 
                ...
                className={`group relative w-full rounded-[2rem] border border-gray-200 flex items-center justify-between px-6 py-5 cursor-pointer transition-all ${
                  uploadedUsdzFile ? 'bg-[rgb(var(--primary-50))] border-[rgb(var(--primary-300))]' : 'bg-gray-50 hover:border-[rgb(var(--primary-300))]'
                }`}
              >
                <div className="flex items-center gap-4">
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all ${
                    uploadedUsdzFile ? 'text-white shadow-lg' : 'bg-gray-200 text-gray-500 group-hover:text-white group-hover:shadow-lg'
                  }`}
                    style={{ backgroundColor: uploadedUsdzFile ? 'rgb(var(--primary-500))' : undefined }}
                  >
                    <IconUploadCloud className="w-6 h-6" />
                  </div>
                  <div>
                    <h4 className={`font-bold text-base ${uploadedUsdzFile ? '' : 'text-gray-900'}`} style={uploadedUsdzFile ? { color: 'rgb(var(--primary-600))' } : undefined}>Upload room model (USDZ) <span className="text-gray-400 font-normal">(optional)</span></h4>
                ...
                <div className="flex items-center gap-3">
                  {uploadedUsdzFile && (
                    <button 
                      ...
                      className="bg-white/80 p-2 rounded-full hover:bg-red-100 hover:text-red-600 transition-all shadow-sm"
                    >
                  ...
                  <div className={`px-5 py-2.5 rounded-full border text-xs font-bold uppercase tracking-wide transition-all ${
                    ...
                    style={uploadedUsdzFile ? { backgroundColor: 'rgb(var(--primary-500))', borderColor: 'rgb(var(--primary-500))' } : undefined}
                  >
              ...
              <div className="rounded-2xl border border-gray-100 bg-gray-50/30 overflow-hidden">
                      ...
                      <button
                        ...
                        className={`max-w-full text-left px-3 py-2 rounded-lg border text-[11px] font-medium leading-snug transition-all shrink-0 line-clamp-2 ${
                          userPrompt === pill
                            ...
                            : 'bg-white border-gray-200 text-gray-600 hover:border-[rgb(var(--primary-300))] hover:bg-[rgb(var(--primary-50))]/50'
                        }`}
                        style={userPrompt === pill ? { backgroundColor: 'rgb(var(--primary-500))', borderColor: 'rgb(var(--primary-500))' } : undefined}
                      >
                        {pill}
                      </button>
                    ))}
                ...
                <div className="px-6 pb-6 pt-2">
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white text-sm text-gray-900 placeholder:text-gray-400 outline-none resize-none min-h-[88px] transition-all focus:ring-2 focus:border-[#7A91EE] focus:ring-[#7A91EE]/20"
                  />
                  <div className="flex justify-between items-center mt-4">
                    ...
                    <button
                      ...
                      disabled={!isLivingRoom || !userPrompt.trim() || !selectedBudget || pipelineStatus === 'uploading' || pipelineStatus === 'running'}
                      className="text-white px-8 py-3 rounded-xl font-semibold text-sm flex items-center gap-2 transition-all disabled:opacity-40 disabled:cursor-not-allowed shadow-lg hover:opacity-90"
                      style={{ backgroundColor: 'rgb(var(--primary-500))', boxShadow: '0 4px 14px rgba(var(--primary-500), 0.35)' }}
                    >
                      {pipelineStatus === 'uploading' || pipelineStatus === 'running' ? (
                        <IconLoader2 className="w-4 h-4 animate-spin" />
                      ) : uploadedUsdzFile ? (
                        <>
                          Generate design <IconArrowRight className="w-4 h-4" />
                        </>
                      ) : (
                        <>
                          Upload USDZ <IconUploadCloud className="w-4 h-4" />
                        </>
                      )}
                    </button>
                  </div>
          ...
          {/* Bottom Badges */}
          <div className="flex justify-center items-center gap-10 text-xs font-bold uppercase tracking-wider shrink-0" style={{ color: 'rgb(var(--text-muted))' }}>
            <div className="flex items-center gap-2 group hover:opacity-80 transition-opacity" style={{ color: 'rgb(var(--primary-500))' }}>
